...
export const getAllSubsubIndustry=createAsyncThunk('getAllSubsubIndustry',async()=>{
    const response=await getQuery(`/leadService/api/v1/industryData/getAllSubSubIndustry`)
    return response.data
})

export const createSubsubIndustry=createAsyncThunk('createSubsubIndustry',async(data)=>{
...
export const createSubIndustry=createAsyncThunk('createSubIndustry',async(data)=>{
  const response=await postQuery(`/leadService/api/v1/industryData/createSubIndustry`,data)
  return response.data
})

export const getAllSubIndustry=createAsyncThunk('getAllSubIndustry',async()=>{
  const response= await getQuery(`/leadService/api/v1/industryData/getAllSubIndustry`)
  return response.data
})
