...
const SideBar = () => {
  ...
  const items = [
    {
      label: "Dashboard", //<Link to={`/erp/${userid}/users`}>Dashboard</Link>,
        ...
        ...(getHighestPriorityRole(currentRoles) !== "ADMIN"
          ? [
              ...
              },
              {
                ...
                // icon: <Icon icon="fluent:checkbox-person-24-regular" />,
                key: "manager",
              },
            ]
          : getHighestPriorityRole(currentRoles) !== "ADMIN" &&
          ...
          ? [
              {
                ...
                // icon: <Icon icon="fluent:person-24-regular" />,
                key: "users",
              },
              {
                label: <Link to={`${userid}/dashboard/tickets`}>Tickets</Link>,
    ...
    getHighestPriorityRole(currentRoles) !== "ADMIN"
      ? [
          {
            label: "Sales", //<Link to={`/erp/${userid}/sales/leads`}>Sales</Link>,
            key: "sales",
    ...
    currentUserDetail?.department === "HR"
      ? [
          {
            label: "HR", //<Link to={`/erp/${userid}/hr`}>HR</Link>,
            key: "hr",
    ...
    getHighestPriorityRole(currentRoles) !== "ADMIN"
      ? [
          {
            label: "Accounts", //<Link to={`/erp/${userid}/account`}>Accounts</Link>,
            key: "account",
    ...
    getHighestPriorityRole(currentRoles) !== "ADMIN"
      ? [
          {
            label: 'Quality',  //<Link to={`/erp/${userid}/quality`}>Quality</Link>,
            key: "quality",
